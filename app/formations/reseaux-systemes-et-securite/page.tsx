...
import { ArrowLeft, CheckCircle, Shield, Server, Network, GraduationCap } from 'lucide-react';

export default function FormationRSS() {
    return (
                ...
                <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                            Réseaux, Systèmes <br /> <span className="text-[#c1a052]">et Sécurité</span> (RSS)
                        </h1>
                        <p className="text-xl text-blue-100/90 leading-relaxed font-medium max-w-2xl">
                            La formation est organisée en 6 semestres. Elle couvre la programmation, les systèmes et réseaux, les bases de données, la science des données, le Big Data, le Cloud et se conclut par un stage de fin d’études.
                        </p>
                    </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        ...
                                        <li>Bases de données I & Technologies web</li>
                                        <li>Bases d’informatique & Concepts des réseaux informatiques</li>
                                ...
                                <div className="pt-4 border-t border-gray-100">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        ...
                                        <li>CMS et PAO (Services Réseaux)</li>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>Programmation Avancée: Orientée Objet (Java), Structures de données</li>
                                        <li>Science des Données: Machine Learning, Recherche Opérationnelle</li>
                                        <li>Réseaux: Introduction aux Réseaux Mobiles, Administration systèmes</li>
                                        <li>Sécurité: Introduction à la sécurité informatique, Bases de données</li>
                                    </ul>
                                </div>
                                <div className="pt-4 border-t border-gray-100">
                                    <h5 className="font-bold text-gray-900 mb-3 text-lg flex items-center gap-2">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>Intelligence Artificielle & JEE (Java EE), Dev mobile</li>
                                        <li>Réseaux: Sécurité réseaux, Voix et ToIP</li>
                                        <li>Droit informatique, protection des données & éthique</li>
                                        <li><strong>Stage de 2ème année</strong></li>
                                        <li>Projet intégrateur avancé II</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow relative overflow-hidden group lg:col-span-2">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>Big Data, Webservices & Cloud (Architecture SOA, Virtualisation)</li>
                                        <li>Préparation Certifications: CCNA & Python</li>
                                        <li>Réseaux & Projets: Réseaux fixes, Gestion de projets Agiles</li>
                                ...
                                <div className="md:pt-16">
                                    <div className="bg-[#0b2a51] text-white p-6 rounded-2xl flex items-center gap-4 hover:bg-[#0c3566] transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-100">Stage de Fin d’Études de Licence. Application pratique des 3 années de formation en milieu professionnel.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
