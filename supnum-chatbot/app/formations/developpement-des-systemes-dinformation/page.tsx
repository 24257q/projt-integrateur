...
import { ArrowLeft, CheckCircle, Database, Server, Code, GraduationCap } from 'lucide-react';

export default function FormationDSI() {
    return (
                ...
                <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                            Développement des <br /> <span className="text-[#c1a052]">Systèmes d’Information</span> (DSI)
                        </h1>
                        <p className="text-xl text-blue-100/90 leading-relaxed font-medium max-w-2xl">
                            Cette formation couvre l’ensemble des compétences nécessaires en programmation, systèmes informatiques, multimédia, science des données et intelligence artificielle pour former des cadres hautement qualifiés.
                        </p>
                    </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        ...
                                        <li>Bases d’informatique & Concepts de base des réseaux</li>
                                ...
                                <div className="pt-4 border-t border-gray-100">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        ...
                                        <li>Mathématiques (Algèbre II, Probabilité et Statistique)</li>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>POO Java, Structures de données & complexité</li>
                                        <li>Machine Learning, Recherche Opérationnelle</li>
                                        <li>Génie logiciel, Bases de données avancées (Oracle)</li>
                                        <li>Développement web avec Python, DevOps</li>
                                    </ul>
                                </div>
                                <div className="pt-4 border-t border-gray-100">
                                    <h5 className="font-bold text-gray-900 mb-3 text-lg flex items-center gap-2">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>Intelligence Artificielle, JEE, Développement mobile</li>
                                        <li>Bases de données NoSQL, Réseaux avancés & sécurité</li>
                                        <li>Droit informatique & éthique</li>
                                        <li><strong>Stage de 2ᵉ année</strong></li>
                                        <li>Projet intégrateur avancé</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow relative overflow-hidden group lg:col-span-2">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                <div>
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-2 pl-7">
                                        <li>Architecture SOA & Webservices, Framework & Big Data, Cloud</li>
                                        <li>Préparation certifications: Oracle & Python</li>
                                        <li>JEE Avancé, Gestion de projets Agiles</li>
                                ...
                                <div className="md:pt-16">
                                    <div className="bg-[#0b2a51] text-white p-6 rounded-2xl flex items-center gap-4 hover:bg-[#0c3566] transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-100">Stage de Fin d’Études de Licence. Application pratique des 3 années de formation en milieu professionnel (PFE).</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
