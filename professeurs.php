...
<input type="recherche"  class="recherche"placeholder="Recherche...">
 ...
 <div style="display: flex; align-items: center; margin-left:15px;">
            ...
            <img src="user.png"  style="margin-left:5px;"class="user"></div><a href="ajouter.php">
          <img class="ajouter"src="plus.png"></a></p>
   <table>
...
<td align="center" style="background-color:rgb(235, 233, 233)"><?php echo $user["email"];?></td>
